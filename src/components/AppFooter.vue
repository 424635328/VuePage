...
const footerConfig = ref({
  columns: [
    ...
    { title: '资源', links: [{ text: '帮助中心', to: '/help' }, { text: '开发者文档', to: '/docs', isExternal: false }, { text: '状态页', href: 'https://status.example.com', isExternal: true },], },
    { title: '法律', links: [{ text: '隐私政策', to: '/privacy' }, { text: '服务条款', to: '/terms' },], },
  ],
  socials: [
    { name: 'GitHub', icon: 'github', url: 'https://github.com/your-profile', label: '访问我们的 GitHub' },
    { name: 'Twitter', icon: 'twitter', url: 'https://twitter.com/your-profile', label: '关注我们的 Twitter' },
    { name: '稀土掘金', icon: 'juejin', url: 'https://juejin.cn/user/your-id', label: '查看我们的稀土掘金' },
    { name: 'Discord', icon: 'discord', url: 'https://discord.gg/your-invite', label: '加入我们的 Discord' },
  ],
  brandName: 'MHStudio',
  slogan: '打造卓越的数字体验。',
});
